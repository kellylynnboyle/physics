...
|---|---|---|---|
| 1 | Kinematics | 2–3 | Algebra I (graphing lines, solving for a variable) |
| 2 | Projectile Motion | 2 | Kinematics |
...
**Students:**
1. Read `01-key-concepts.md` before class to preview vocabulary and formulas.
2. Fill out `02-cornell-notes.md` during/after instruction (the cue column is
   pre-seeded with the questions instructors say students most often can't
   answer without prompting — use them to self-test).
3. Take `03-quiz.md` *without notes* after finishing the unit. Check answers
   against the explanations, not just the answer key — the explanations
   target the exact misconception that causes each wrong answer.
4. Work at least 3 problems from `04-resources-and-problems.md` and pick one
   real-world application to explain in your own words.
5. Complete the self-assessment in `05-assessment-checklist.md` and log your
   result in `PROGRESS-TRACKER.md`.

**Instructors:**
- Each `05-assessment-checklist.md` includes a mastery rubric (Emerging /
